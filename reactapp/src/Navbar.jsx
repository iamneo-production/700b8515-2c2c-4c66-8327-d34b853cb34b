        ...
        <nav className="navbar navbar-expand-lg" style={{color:'white',backgroundColor:'#42618f',textAlign:'center',border:'2px solid black',fontSize:25}}>
            <div className="container-fluid">
                ...
                <ul className="navbar-nav me-auto mb-5 mb-lg-2">
                    ...
                    <li className="nav-item px-5">
                        <a className="nav-link" style={{color:'white'}} href="/" id1={props.id1} >{props.title1}</a>
                    </li>
                    <li className="nav-item px-5">
                        <a className="nav-link active" style={{color:'white'}} aria-current="page" href="/" id2={props.title2}>{props.title2}</a>
                    </li>
                    <li className="nav-item px-5">
                        <a className="nav-link" style={{color:'white'}} href="/" id3={props.id3}>{props.title3}</a>
                    </li>
                    <li className="nav-item px-5">
                        <a className="nav-link" style={{color:'white',paddingLeft:'500px'}} href="/" id="Logout">Logout</a>
                    </li>
                </ul>            
                </div>
            </div>
