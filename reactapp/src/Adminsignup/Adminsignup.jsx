...
export default function Signup() {
  ...
  const handleSignup = () => {
    ...
    axios.post('https://8080-dbdecfdfcdefbfbfaacdedbbaffaccbcbcbbd.project.examly.io/auth/admin/signup', userData)
      .then((response) => {
    ...
    <div style={{ zoom: '110%' }}>
      ...
      <div className="my-0" style={{ paddingLeft: '280px', border: '2px solid black', backgroundColor: '#c6c1cf', paddingBottom: '200px' }}>
        ...
        <div style={{ paddingLeft: '270px', fontSize: 25 }}>
          ...
          >
          <Link to="/Adminaddpolicy">Sign Up</Link>
          </button>
        </div>
        <div style={{ paddingLeft: '270px', fontSize: 25 }}>
          <strong className='mx-2' style={{ fontSize: 20 }}>Already a Admin?</strong>
          <button
            type="button"
            className="btn btn-outline-dark btn-lg"
            style={{ color: 'blue', border: 'none', backgroundColor: '#c6c1cf' }}
